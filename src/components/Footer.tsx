            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-yellow-400 text-xs font-bold tracking-[0.2em] uppercase mt-1">CT e Hotel</p>
                            </div>
                        </div>

                        {/* Contact List */}
                        <div className="space-y-4">
                            <h4 className="text-yellow-400 font-bold uppercase tracking-wider text-sm border-b border-yellow-400/20 pb-2 inline-block">
                                Fale Conosco
                            </h4>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="space-y-3 w-full">
                                    <div className="flex justify-between items-center border-b border-white/10 pb-2">
                                        ...
                                        <p className="text-yellow-400/90 text-sm font-mono">08h-12h / 14h-18h</p>
                                    </div>
                                    <div className="flex justify-between items-center pt-1">
                                        <p className="text-white font-bold text-sm">Domingo</p>
                                        <p className="text-yellow-400/90 text-sm font-mono">08h-12h / 14h-16h</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="border-t border-green-600/50 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-green-200/60">
                    ...
                    <p className="flex items-center gap-1.5 transition-colors hover:text-green-200">
                        Desenvolvido por <span className="text-yellow-400/80 font-bold tracking-wide">Auto Social Flow</span>
                    </p>
                </div>
            </div>
        </footer>
