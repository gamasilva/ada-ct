            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid md:grid-cols-3 gap-12 mb-16">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-yellow-200 text-xs font-bold tracking-[0.2em] uppercase mt-1">CT e Hotel</p>
                            </div>
                        </div>

                        {/* Contact List */}
                        <div className="space-y-4">
                            <h4 className="text-yellow-200 font-bold uppercase tracking-wider text-sm border-b border-yellow-200/30 pb-2 inline-block">
                                Fale Conosco
                            </h4>
                            <ul className="space-y-4">
                                <li>
                                    <a href="https://wa.me/5528999574221" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group min-h-[48px]">
                                        ...
                                        <span className="text-gray-50 group-hover:text-white transition-colors font-medium">+55 (28) 99957-4221</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="mailto:contato@rk9.com.br" className="flex items-center gap-4 group min-h-[48px]">
                                        ...
                                        <span className="text-gray-50 group-hover:text-white transition-colors font-medium">contato@rk9.com.br</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.instagram.com/ctromeirok9" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group min-h-[48px]">
                                        ...
                                        <span className="text-gray-50 group-hover:text-white transition-colors font-medium">@ctromeirok9</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="space-y-6">
                        <div>
                            <h4 className="text-yellow-200 font-bold uppercase tracking-wider text-sm border-b border-yellow-200/30 pb-2 inline-block mb-4">
                                Localização
                            </h4>
                            <div className="flex items-start gap-3 text-gray-50 mb-6">
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="space-y-3 w-full">
                                    <div className="flex justify-between items-center border-b border-white/10 pb-2">
                                        ...
                                        <p className="text-yellow-200 text-sm font-mono">08h-12h / 14h-18h</p>
                                    </div>
                                    <div className="flex justify-between items-center pt-1">
                                        <p className="text-white font-bold text-sm">Domingo</p>
                                        <p className="text-yellow-200 text-sm font-mono">08h-12h / 14h-16h</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-4 items-start bg-yellow-400/5 p-5 rounded-xl border border-yellow-400/10">
                            ...
                            <div className="space-y-2">
                                <p className="text-xs text-gray-50 italic leading-relaxed">
                                    <span className="text-yellow-200 not-italic font-bold">Tolerância de 15min na busca.</span>
                                </p>
                                <p className="text-xs text-gray-50 italic leading-relaxed">
                ...
                {/* Bottom Bar */}
                <div className="border-t border-green-600/50 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-green-100/90">
                    <p>&copy; 2026 RK9 CT e Hotel. Todos os direitos reservados.</p>
                    <a
                        href="https://www.autosocialflow.com.br/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-1.5 transition-colors hover:text-green-100"
                    >
                        Desenvolvido por <span className="text-yellow-200 font-bold tracking-wide">Auto Social Flow</span>
                    </a>
                </div>
            </div>
        </footer>
